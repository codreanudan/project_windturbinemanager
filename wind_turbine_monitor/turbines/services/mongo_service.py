...
class MongoService:
    ...
    def _connect(self):
        ...
        try:
            ...
            db_name =  'WIND_TURBINE_MONITOR'
            collection_name = 'WIND_TURBINE_MONITOR'
    ...
    def _serialize_for_mongo(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Store all fields as plain JSON (no datetime conversion, no extra fields)"""
        serialized = {}
        for key, value in data.items():
            if key == 'id':
                continue  # skip DRF id, MongoDB will use _id
            serialized[key] = value
        return serialized
    ...
    def create_turbine(self, data: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            print("Inserting into MongoDB:", mongo_data)
